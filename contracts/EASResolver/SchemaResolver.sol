...
abstract contract SchemaResolver is ISchemaResolver, Semver {
     ...
     * @inheritdoc ISchemaResolver
     */
    function attest(Attestation calldata attestation) external payable onlyEAS override returns (bool) {
    ...
    ) external payable onlyEAS override returns (bool) {
     ...
     * @inheritdoc ISchemaResolver
     */
    function revoke(Attestation calldata attestation) external payable onlyEAS override returns (bool) {
